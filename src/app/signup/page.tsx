...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Usa signInWithOtp invece di signUp per passwordless
        ...
        <div className="w-full max-w-md">
          <Card className="p-8 shadow-lg border-0 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Ciao <span className="font-medium text-gray-900">{name}</span>!
            </p>
            ...
            <div className="space-y-3 text-sm text-gray-600 bg-gray-50 p-4 rounded-lg">
              <p className="font-medium text-gray-900">Cosa fare ora:</p>
              <ol className="text-left space-y-2 list-decimal list-inside">
                <li>Controlla la tua casella email</li>
                <li>Clicca sul link di accesso</li>
        ...
        <Card className="p-8 shadow-lg border-0">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-sm">
              Inizia la tua ricerca della casa perfetta
            </p>
          </div>
